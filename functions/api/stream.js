...
export async function onRequestGet({ request, env }) {
  ...
  try {
    const headers={ 'Accept':'text/event-stream', 'X-RYVEX-API-KEY':key, 'X-RYVEX-PLATFORM':'website', 'X-RYVEX-PLATFORM-VERSION':'2.4.0', 'X-RYVEX-USER-ID':String(gate.session.sub) };
