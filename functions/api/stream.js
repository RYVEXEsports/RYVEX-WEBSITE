...
export async function onRequestGet({ request, env }) {
  ...
  try {
    const headers={ 'Accept':'text/event-stream', 'X-RYVEX-API-KEY':key, 'X-RYVEX-PLATFORM':'website', 'X-RYVEX-PLATFORM-VERSION':WEBSITE_VERSION, 'X-RYVEX-USER-ID':String(gate.session.sub) };
